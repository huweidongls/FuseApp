...
public class SafeDetailsActivity extends BaseActivity {

    private Context context = SafeDetailsActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ButterKnife.bind(SafeDetailsActivity.this);
        initData();
    ...
    private void initData() {
        ...
        map.put("id", id);
        ViseUtil.Get(context, NetUrl.AppSaveInfogetOne, map, new ViseUtil.ViseListener() {
            @Override
