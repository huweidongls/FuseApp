...
import com.guoyu.fuseapp.page.CreditDetails2Activity;
...
public class CreditList2Adapter extends RecyclerView.Adapter<CreditList2Adapter.ViewHolder> {

    private Context context;
    private List<CreditList2Bean.RowsBean> data;

    public CreditList2Adapter(List<CreditList2Bean.RowsBean> data) {
        this.data = data;
    }
